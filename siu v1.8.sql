...
CREATE TABLE Perfiles (
  ...
  cargo_perfil varchar (70) NOT NULL,
  PK_codigo_estatus TINYINT(2) NOT NULL,
  PK_carnet_alumno VARCHAR (100) NOT NULL,
  PK_codigo_maestro VARCHAR (100) NOT NULL,
  PK_id_usuario VARCHAR (100) NOT NULL,
  
  PRIMARY KEY (PK_id_perfil),
  FOREIGN KEY (PK_id_perfil) REFERENCES permisos (PK_id_usuario),
  FOREIGN KEY (PK_id_perfil) REFERENCES alumnos (PK_carnet_alumno),
  FOREIGN KEY (PK_id_perfil) REFERENCES maestros (PK_codigo_maestro)
